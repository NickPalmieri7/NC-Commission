...
class _FullAddressPageState extends State<FullAddressPage> {
 ...
 void _autocompleteAddress(String query) {
  ...
  actions: [
    ...
    SizedBox(width: 1), // Adjust this value to create the desired spacing
    IconButton(
          ...
          ? Column(
              ...
              children: _searchResults.map((result) {
                if (result.length > 8) { // Adjusted to include up to column I (commission)
                  ...
                  double fontSize = commissionValue > 1000 ? 14.0 : (isLargeNumber ? 18.0 : 20.0);
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Container(
                            width: 100.0, // Increased width to accommodate larger text
